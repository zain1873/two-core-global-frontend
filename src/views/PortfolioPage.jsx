...
// function ProjectCard({ project, onHoverImage, onLeaveImage }) {
...
//       <div
//         className="pf-card-image-wrap"
//         onMouseEnter={() => onHoverImage(project)}
...
// /* Inline-styled — no external CSS file needed, so this can never fail to show
//    because of a missing class or import mismatch. Keeps the last hovered
//    project remembered so the image stays mounted while fading out, instead
//    of vanishing instantly the moment the mouse leaves. */
// function ImageHoverZoom({ project }) {
...
//                 key={project.id}
//                 project={project}
//                 onHoverImage={setHoveredProject}
//                 onLeaveImage={() => setHoveredProject(null)}
//               />
//             ))
//           ) : (
...
//       <ImageHoverZoom project={hoveredProject} />
//     </div>
//   );
// }
